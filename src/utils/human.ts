...
export class HumanBehavior {
   ...
   */
  static randomDelay(min: number = 100, max: number = 800): Promise<void> {
   ...
   */
  static async smoothScrollIntoView(page: Page, selector: string): Promise<void> {
    const element = page.locator(selector);
   ...
   */
  static async moveToElement(page: Page, selector: string): Promise<void> {
    const element = page.locator(selector);
   ...
   */
  static async naturalPause(): Promise<void> {
   ...
   */
  static async humanSelectDropdown(page: Page, selector: string, value: string): Promise<void> {
   ...
   */
  static async humanCheckCheckbox(page: Page, selector: string): Promise<void> {
    await this.smoothScrollIntoView(page, selector);
    await this.moveToElement(page, selector);
   ...
   */
  static async humanFillField(page: Page, selector: string, value: string): Promise<void> {
    await this.smoothScrollIntoView(page, selector);
    await this.moveToElement(page, selector);
    await this.randomDelay(100, 300);
