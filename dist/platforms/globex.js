...
class GlobexHandler extends base_1.BasePlatformHandler {
    ...
    async handlePersonalInfoSection(page, profile) {
        ...
        try {
            ...
            await page.evaluate(() => {
                ...
                const educationHeader = educationSection?.querySelector('.accordion-header');
                if (educationHeader) {
    ...
    async handleEducationSection(page, profile) {
        ...
        try {
            ...
            await schoolResults.evaluate(el => el.style.display = 'block');
            ...
            for (const profileSkill of profile.skills) {
                ...
                if (dataSkill) {
                    try {
                        ...
                        await skillChip.evaluate(el => el.style.visibility = 'visible');
                        ...
                        if (!isSelected) {
                            await human_1.HumanBehavior.hoverThenClick(page, `.chip[data-skill="${dataSkill}"]`);
