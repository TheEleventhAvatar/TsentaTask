...
exports.ATSDetector = void 0;
const logger_1 = require("../utils/logger");
class ATSDetector {
    /**
     * Detect the ATS platform based on URL and page content
     */
    static async detectPlatform(page, url) {
     ...
     */
    static async checkPlatform(page, url, platformName, patterns) {
        const indicators = [];
        let confidence = 0;
        // Check URL patterns
     ...
     */
    static async checkPlatformCharacteristics(page, platformName) {
        const indicators = [];
        let confidence = 0;
        switch (platformName) {
            case 'ACME':
     ...
     */
    static async hasElements(page, selectors) {
     ...
     */
    static async validateDetection(page, detectedPlatform) {
        const logger = logger_1.Logger.getInstance();
        try {
            ...
            const patterns = this.PLATFORM_PATTERNS[detectedPlatform];
            if (patterns) {
     ...
     */
    static async checkContentMarkers(page, markers) {
        try {
            const pageContent = await page.content();
     ...
     */
    static addPlatformPattern(platformName, patterns) {
        this.PLATFORM_PATTERNS[platformName] = patterns;
        const logger = logger_1.Logger.getInstance();
     ...
     */
    static getDetectionStats(result) {
        return {
...
exports.ATSDetector = ATSDetector;
ATSDetector.PLATFORM_PATTERNS = {
    ACME: {
        urlPatterns: [
            /acme.*corp/i,
            /acme.*ats/i,
...
//# sourceMappingURL=ats-detector.js.map